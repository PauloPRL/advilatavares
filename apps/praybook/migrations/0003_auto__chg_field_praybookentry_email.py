...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PrayBookEntry.email'
        db.alter_column(u'praybook_praybookentry', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

    def backwards(self, orm):

        # Changing field 'PrayBookEntry.email'
        db.alter_column(u'praybook_praybookentry', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75))
