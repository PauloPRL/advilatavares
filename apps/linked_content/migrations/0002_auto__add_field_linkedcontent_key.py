...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LinkedContent.key'
        db.add_column(u'linked_content_linkedcontent', 'key',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LinkedContent.key'
        db.delete_column(u'linked_content_linkedcontent', 'key')
