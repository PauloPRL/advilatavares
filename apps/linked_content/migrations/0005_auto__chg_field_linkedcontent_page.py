...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LinkedContent.page'
        db.alter_column(u'linked_content_linkedcontent', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pages.Page'], null=True))

    def backwards(self, orm):

        # Changing field 'LinkedContent.page'
        db.alter_column(u'linked_content_linkedcontent', 'page_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['pages.Page']))
