...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Member.marital_status'
        db.alter_column(u'members_member', 'marital_status', self.gf('django.db.models.fields.CharField')(max_length=8))

    def backwards(self, orm):

        # Changing field 'Member.marital_status'
        db.alter_column(u'members_member', 'marital_status', self.gf('django.db.models.fields.CharField')(max_length=7))
    ...
    models = {
        ...
        u'members.member': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'marital_status': ('django.db.models.fields.CharField', [], {'default': "u'single'", 'max_length': '8'}),
