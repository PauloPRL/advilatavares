...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Member', fields ['cpf']
        db.delete_unique(u'members_member', ['cpf'])

        # Removing unique constraint on 'Member', fields ['rg']
        db.delete_unique(u'members_member', ['rg'])


        # Changing field 'Member.rg'
        db.alter_column(u'members_member', 'rg', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'Member.complement'
        db.alter_column(u'members_member', 'complement', self.gf('django.db.models.fields.CharField')(max_length=u'20', null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Member.rg'
        raise RuntimeError("Cannot reverse this migration. 'Member.rg' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Member.rg'
        db.alter_column(u'members_member', 'rg', self.gf('django.db.models.fields.CharField')(max_length=15, unique=True))
        # Adding unique constraint on 'Member', fields ['rg']
        db.create_unique(u'members_member', ['rg'])


        # User chose to not deal with backwards NULL issues for 'Member.complement'
        raise RuntimeError("Cannot reverse this migration. 'Member.complement' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Member.complement'
        db.alter_column(u'members_member', 'complement', self.gf('django.db.models.fields.CharField')(max_length=u'20'))

        # User chose to not deal with backwards NULL issues for 'Member.cpf'
        raise RuntimeError("Cannot reverse this migration. 'Member.cpf' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Member.cpf'
        db.alter_column(u'members_member', 'cpf', self.gf('django.db.models.fields.CharField')(max_length=11, unique=True))
        # Adding unique constraint on 'Member', fields ['cpf']
        db.create_unique(u'members_member', ['cpf'])
    ...
    models = {
        ...
        u'members.member': {
            ...
            'cpf': ('django.db.models.fields.CharField', [], {'max_length': '11', 'null': 'True', 'blank': 'True'}),
